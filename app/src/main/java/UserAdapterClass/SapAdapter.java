...
public class SapAdapter extends FirebaseRecyclerAdapter <saphelper,SapAdapter.SapViewholder>{
    ...
    @Override
    protected void onBindViewHolder(@NonNull SapViewholder holder, int position, @NonNull saphelper model) {
        holder.saplinear.setVisibility(View.GONE);
